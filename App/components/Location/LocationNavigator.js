...
var ThingsMap = require('./ThingsMap');
...
var LocationNavigator = React.createClass({
      ...
      Title: function(route, navigator, index, navState) {
        return (
          <Text style={[styles.navBarText, styles.navBarTitleText]}>
            {route.name=="Location"?g_Lan.tab_bar_location():route.name}
          </Text>
        );
      },
    }
  ...
  render:function(){
    return(
        <Navigator
          ...
          />}
          initialRoute={{component:ThingsMap,name:"Location"}}
          renderScene = {(route, navigator) =>{
            let ThMap = route.component;
            navigator.Hide=this._hideNavigator
            navigator.Show=this._showNavigator
            return(
              <View style={{flex:1}}>
              <View style={this._navStyle()}/>
              <ThMap navigator={navigator} {...route.params} />
            </View>
            )
          }}
        />
...
module.exports = LocationNavigator;
